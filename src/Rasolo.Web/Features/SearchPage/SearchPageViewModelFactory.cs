...
namespace Rasolo.Core.Features.SearchPage
{
	public class SearchPageViewModelFactory : BaseContentPageViewModelFactory<Web.Features.SearchPage.SearchPageViewModel>, ISearchPageViewModelFactory
	{
		...
		(
			IPublishedContentMapper anaxiMapper,IHttpContextAccessor httpContextAccessor, IUmbracoHelper umbracoHelper, IHttpUtility httpUtility, IGlobalSettingsPageViewModelFactory globalSettingsPageViewModelFactory, IExamineSearcher examineSearcher)
